...
Plastic.create(name:'Plastic Info 1', info:'marine animals are killed by plastic each year', stats:100000)
...
# Plastic.create(name: 'Plastic Bags',
#  info: 'Sea turtles can mistake clear plastic bags for one of their favorite foods which is the jellyfish.
...
#  1 trillion plastic bags are produced worldwide in one year and every year Americans use 102.1 billion plastic bags
#  1,000 turtles die each year from being tangled in plastic waste
# ')

# Plastic.create(name: 'Plastic bottles', info: '
...
# 92%of seabirds found in a test area ingested plastic. Bottle caps are not recycled
# On average per person approximately 185 lbs of plastic is thrown away per year.
# ')

# Plastic.create(name: '?', info: '500 Million')

# Plastic.create(name: 'Styrofoam', info: "It's everywhere!! 25 billion plastic foam coffe cups alone are thrown away each year.
# Plastic foam is the most harmful material for the environment.
# Less than 1% of all plastic foam is recycled.
# An estimated 4 million to 12 million tonnes of plastic enter Earth’s oceans every year.")
